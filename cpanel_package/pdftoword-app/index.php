...
<body>
  ...
  <main class="wrap content">
    ...
    <section class="embed-layout">
      <aside class="ad-rail" aria-label="Publicidade lateral esquerda">
        <div class="ad-label">Espaco para Anuncio (Lateral Esquerda)</div>
        <div class="ad-box ad-box-tall">
          <!-- Inserir aqui o script do anuncio lateral esquerdo -->
        </div>
      </aside>
      ...
      <aside class="ad-rail" aria-label="Publicidade lateral direita">
        <div class="ad-label">Espaco para Anuncio (Lateral Direita)</div>
        <div class="ad-box ad-box-tall">
          <!-- Inserir aqui o script do anuncio lateral direito -->
        </div>
      </aside>
    </section>
